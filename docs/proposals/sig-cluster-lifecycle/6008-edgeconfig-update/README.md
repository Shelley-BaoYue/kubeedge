---
title: Support Update EdgeCore Configuration from Cloud
authors:
- "@Shelley-BaoYue"
approvers:
...
- Support updating edge config on single or multi edge node(s).
- Support partial field updates to the edge configuration.
